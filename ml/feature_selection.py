...
# ------------------------------
def fs_none(X, y, names, k=None):
    return X, list(names)

# ------------------------------
# RFE with Random Forest
# ------------------------------
def fs_rfe_rf(X, y, names, k):
...
# ------------------------------
# Genetic Algorithm (proxy)
# ------------------------------
def fs_ga(X, y, names, k):
